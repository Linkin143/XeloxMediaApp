...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const serviceCatalog = [
    ...
    {
      id: 'meta-ads-account-setup',
      url: 'meta-ads-account-setup.html',
      title: 'Meta Ads Account Setup',
      description: 'Account structure, pixel, and tracking setup for Meta campaigns.',
      price: 5000,
      billing: 'one-time',
      icon: serviceIcons.strategy,
    },
    ...
    {
      id: 'google-ads-account-setup',
      url: 'google-ads-account-setup.html',
      title: 'Google Ads Account Setup',
      description: 'Search account creation, conversion tracking, and campaign groundwork.',
      price: 5000,
      billing: 'one-time',
      icon: serviceIcons.strategy,
    },
